...
def SignToText(request):
    model = keras.models.load_model("static/hdf/model.h5")
...
# For webcam input:
    ...
    # Draw the hand annotations on the image.
        ...
        # get the predicted class for each sample
                ...
                detectedletters.append(label)
                print("------------------------")
            print(detectedletters)
            time.sleep(3)    

            # x =  ''.join(detectedletters) 
            # print('inside',x)
    ...
    # output image
        ...
        if len(x) == 4:
            ...
            print('TEST')
            print('HHHHHH',x)
            return render(request,"output.html",{'data':x})
    ...
    # responsedata={'detectedletters':detectedletters}
